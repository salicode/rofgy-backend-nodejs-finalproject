...
//to push to docker account
// docker tag socialapp:latest salisu/socialapp:latest
// docker tag socialapp:latest salisu/socialapp:latest
...
const uri = "mongodb+srv://salisuaminu615:N80B22jR6Ukm68R8@cluster0.hv7qm.mongodb.net/SocialDB?retryWrites=true&w=majority&appName=Cluster0";
mongoose.connect(uri, { dbName: "SocialDB" });
...
app.post("/register", async (req, res) => {
  ...
  try {
    ...
    console.log("SECRET_KEY (Register):", SECRET_KEY);
...
app.post("/login", async (req, res) => {
  ...
  try {
    ...
    console.log("SECRET_KEY (Login):", SECRET_KEY);
